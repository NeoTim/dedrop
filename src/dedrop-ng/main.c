...
void *thread()
{
    ...
    // execute setup code
    PyRun_SimpleString("import importlib; print(importlib._bootstrap_external._get_supported_file_loaders()); import dedrop; import sys; # print(sys.modules); print(sys.modules['dedrop'])");
    char dirty[256];
